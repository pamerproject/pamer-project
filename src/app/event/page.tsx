            ...
            <Link key={ev.id} href={`/event/${ev.slug}`} className="group block">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  {/* Title */}
                  <h3 className="mt-2 text-sm font-bold leading-snug text-[var(--foreground)] transition-colors line-clamp-2 group-hover:text-[var(--brand)]">
                    {ev.title}
                  </h3>

                  {/* Description */}
                  <p className="mt-1.5 text-xs leading-relaxed text-[var(--muted)] line-clamp-2">{ev.description}</p>
