...
export default function EventDetailPage() {
  ...
  return (
    <div className="space-y-4 pb-12 md:pb-0">
      ...
      {/* ── Detail Event ── */}
      <div className="space-y-5 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-4 md:p-5">
      ...
      {/* ── Participants ── */}
      <div className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-4 md:p-5">
        <h2 className="flex items-center gap-1.5 text-base font-black tracking-tight text-[var(--foreground)]">
          <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
