...
export default function Home() {
  ...
  return (
    <div className="space-y-2">
      {status === "loading" ? (
        <div className="overflow-hidden rounded-2xl border border-[var(--card-border)] bg-[var(--card)] px-4 py-8 text-center md:rounded-none md:border-0 md:border md:px-8 md:py-12 animate-pulse">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[var(--card-border)] bg-[var(--card)] px-4 py-8 text-center md:rounded-none md:border-0 md:border md:px-8 md:py-12">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[var(--card-border)] bg-[var(--card)] px-4 py-16 text-center md:rounded-none md:border-0 md:border md:px-8 md:py-20">
          <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-[var(--brand)]/5 md:block" />
          <div className="absolute -bottom-10 -left-10 h-32 w-32 rounded-full bg-[var(--brand)]/5 md:block" />
