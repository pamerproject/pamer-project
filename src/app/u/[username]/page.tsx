      ...
      <div>
        {/* ── Cover Photo ─────────────────────────────── */}
            <div className="group relative h-48 overflow-hidden md:h-56 md:rounded-t-xl">
              ...
              {/* Tombol Edit Profil — pojok kanan atas card (hanya untuk pemilik profil) */}
              {isOwnProfile && (
                <Link
                  href="/settings"
                  className="absolute right-3 top-3 z-20 inline-flex items-center gap-1.5 rounded-full bg-black/50 px-4 py-2 text-xs font-semibold text-white backdrop-blur-sm transition-all hover:bg-black/70 active:scale-95"
                >
