                ...
                >
                  ...
                  <div className="p-2.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="ml-auto inline-flex items-center gap-1 rounded-md bg-emerald-100 px-1.5 py-0.5 text-[10px] font-bold text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400">
                        {clockIcon}
                        {ev.duration}
                      </span>
                    </div>
                    <p className="mt-1.5 text-xs font-bold leading-snug text-[var(--foreground)] line-clamp-2">
                      {ev.title}
                    </p>
