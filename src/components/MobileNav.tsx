...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 z-50 flex w-full bg-[var(--card)] md:hidden">
      <div className="flex w-full items-center justify-around border-t border-[var(--card-border)] bg-[var(--card)] px-2 pb-[calc(env(safe-area-inset-bottom)+0.375rem)] pt-3">
        {items
