...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 z-50 flex w-full bg-[var(--card)] md:hidden">
      <div className="flex w-full items-center justify-around border-t border-[var(--card-border)] bg-[var(--card)] px-2 pb-[env(safe-area-inset-bottom)] pt-2" style={{ transform: "translateY(-16px)" }}>
        {items
