...
export default function FeedItem({
  ...
  return (
    <article className={`border-b border-l border-r border-[var(--card-border)] bg-[var(--card)] px-2 rounded-2xl md:rounded-xl md:border-t md:px-0 ${pinned ? "ring-2 ring-red-500/70" : ""}`}>
